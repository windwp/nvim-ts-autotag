...
local data = {
    ...
    {
        name = 'html rename tag on normal mode change',
        filepath = './sample/index.html',
        filetype = 'html',
        linenr = 10,
        key = [[dwhi]],
        before = [[<str|ong> </strong>]],
        after = [[<st|r> </str>]],
    },
    {
        name = 'html rename tag on normal mode change where cursor is moved',
        filepath = './sample/index.html',
        filetype = 'html',
        linenr = 10,
        key = [[xi]],
        before = [[<str|ong class="lla"> </strong>]],
        after = [[<str|ng class="lla"> </strng>]],
    },
    {
        -- NOTE: this is a potential limitation/bug
        name = 'html rename tag on normal mode change where cursor is combined with another word',
        filepath = './sample/index.html',
        filetype = 'html',
        linenr = 10,
        key = [[dwi]],
        before = [[<str|ong class="lla"> </strong>]],
        after = [[<str|class="lla"> </strclass>]],
    },
    {
        name = 'html rename tag on normal mode change where cursor is between words',
        filepath = './sample/index.html',
        filetype = 'html',
        linenr = 10,
        key = [[dei]],
        before = [[<str|ong class="lla"> </strong>]],
        after = [[<str| class="lla"> </str>]],
    },
    {
        name = 'html rename tag on normal mode paste',
        filepath = './sample/index.html',
        filetype = 'html',
        linenr = 10,
        key = [[yiwPi]],
        before = [[<str|ong class="lla"> </strong>]],
        after = [[<stron|gstrong class="lla"> </strongstrong>]],
    },
    {
